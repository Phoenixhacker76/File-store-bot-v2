...
UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', "-1002121447195","-1002092721991"))
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", None)).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1001997311109')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", "21366247"))
	API_HASH = os.environ.get("API_HASH", "1d6666d32848a6878c191167a491205d")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6737660591:AAEDC_K7qdha0hvF2UnR8L1pxd6Cx8sTg3w")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Brookv2_probot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1001838078113"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1425888381"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://drakestreality:drakestreality@darkreality.xsnj5id.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002121447195")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002109144230")
